    ...
    >
      ...
      <Box
        sx={{
          ...
          inset: 0,
          backgroundImage:
            'radial-gradient(circle at 2px 2px, rgba(51, 204, 255, 0.05) 1px, transparent 0)',
      ...
      <Box
        sx={{
          ...
          inset: 0,
          background:
            'linear-gradient(135deg, rgba(255, 51, 102, 0.02) 0%, transparent 50%, rgba(51, 204, 255, 0.02) 100%)',
          pointerEvents: 'none',
        }}
      />
        ...
        >
          ...
          <Box>
            ...
            <Stack direction="row" spacing={2} justifyContent="center" alignItems="center">
              ...
              <Typography
                variant="overline"
                sx={{ color: '#33ccff', fontWeight: 900, letterSpacing: 6 }}
              >
          ...
          >
            <Typography
              variant="body1"
              sx={{ color: '#64748b', lineHeight: 2, fontSize: '1rem', fontFamily: 'monospace' }}
            >
              &gt;_ System administrative isolation engaged. The production environment of A.
              Mohamed Yasar is currently being synchronized with a new architectural blueprint. All
              external nodes are restricted until the handshake sequence completes.
            </Typography>
          </Paper>
          ...
          <Stack direction="row" spacing={3} alignItems="center" sx={{ opacity: 0.6 }}>
            <Box
              sx={{ p: 1, bgcolor: 'rgba(51, 204, 255, 0.1)', borderRadius: 1.5, color: '#33ccff' }}
            >
              <Cpu size={20} />
            </Box>
            <Box sx={{ textAlign: 'left' }}>
              ...
              <Typography
                variant="caption"
                sx={{ color: '#444', fontFamily: 'monospace', letterSpacing: 2 }}
              >
                CORE_v4.2.0 // BYPASS_BLOCKED
              </Typography>
            </Box>
          </Stack>
        </Stack>
