              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    inset: 0,
                    opacity: 0.15,
                    backgroundImage: 'radial-gradient(#33ccff 0.5px, transparent 0.5px)',
              ...
              <Box>
                ...
                >
                  ...
                  >
                    Engineering{' '}
                    <span
                      style={{ color: '#ff3366', textShadow: '0 0 20px rgba(255, 51, 102, 0.3)' }}
                    >
                      Modern
                    </span>{' '}
                    Scalable Ecosystems
              ...
              <Grid container spacing={3}>
                {[
                  ...
                  },
                  {
                    ...
                    value:
                      profile.heroMetrics?.find((m) => m.label === 'EXPERIENCE')?.val || '2+ Years',
                    color: '#ec4899',
                  },
                  {
                    label: 'Projects Launched',
                    value: `${profile.projects?.length || 0}+ Total`,
                    color: '#10b981',
                  },
                ].map((stat, i) => (
