...
const YasarSystemHUD = () => {
  ...
  return (
    <Box
      sx={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 1000, overflow: 'hidden' }}
    >
      ...
      <Box sx={{ position: 'absolute', top: { xs: 90, md: 140 }, right: 30, textAlign: 'right' }}>
        ...
        <Typography
          sx={{ color: '#444', fontFamily: 'monospace', fontSize: '0.55rem', fontWeight: 700 }}
        >
      ...
      <Box sx={{ position: 'absolute', bottom: 30, left: 30 }}>
        ...
        <Typography
          sx={{ color: 'rgba(255,255,255,0.1)', fontFamily: 'monospace', fontSize: '0.5rem' }}
        >
      ...
      <Box sx={{ position: 'absolute', bottom: 30, right: { xs: 30, md: 380 } }}>
        <Stack spacing={1} alignItems="flex-end">
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Typography
              sx={{ color: 'white', fontFamily: 'monospace', fontSize: '0.7rem', width: 40 }}
            >
