...
const SystemArchitecture = () => {
  ...
  return (
    <Box
      id="architecture"
      sx={{ py: { xs: 10, md: 20 }, bgcolor: 'rgba(51, 204, 255, 0.02)', position: 'relative' }}
    >
                      ...
                      >
                        <Stack direction="row" spacing={isSmall ? 2 : 3} alignItems="center">
                          ...
                          <Box>
                            ...
                            <Typography
                              variant="caption"
                              sx={{ color: '#444', fontWeight: 700, fontSize: '0.6rem' }}
                            >
                              {tech.desc.toUpperCase()}
                            </Typography>
                          </Box>
                        </Stack>
                      </Box>
            ...
            <Stack spacing={{ xs: 3, md: 4 }}>
              ...
              >
                ...
                <Stack spacing={2}>
                  {[
                    ...
                    >
                      <Typography variant="caption" sx={{ color: '#444', fontWeight: 900 }}>
                        {s.l}
                      </Typography>
                      <Chip
                        label={s.v}
              ...
              >
                ...
                <Stack direction="row" spacing={3} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ color: 'white', fontWeight: 900, fontSize: '0.75rem' }}>
                      SSL_SECURED
                    </Typography>
