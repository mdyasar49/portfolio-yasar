...
import { Box, Button, Menu, MenuItem, Typography, Stack, Tooltip, Fade } from '@mui/material';
      ...
      >
        ...
        >
          ...
          <Box>
            ...
            <Typography
              variant="caption"
              sx={{ color: '#444', fontWeight: 700, fontSize: '0.55rem' }}
            >
              SELECT_DOCUMENT_INTERFACE
            </Typography>
          </Box>
        </Box>
          ...
          {languages.map((lang) => (
            ...
            >
              ...
              <Box sx={{ flexGrow: 1 }}>
                ...
                <Typography
                  variant="caption"
                  sx={{ color: '#444', fontSize: '0.65rem', fontWeight: 700 }}
                >
              ...
              {currentLanguage === lang.code && (
                <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }}>
                  <Box sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: '#33ccff' }} />
                </motion.div>
              )}
            </MenuItem>
          ))}
        ...
        <Box sx={{ mt: 1, p: 1.5, bgcolor: 'rgba(0,0,0,0.2)', borderRadius: 2 }}>
          <Typography
            sx={{ color: '#333', fontSize: '0.6rem', fontWeight: 900, textAlign: 'center' }}
          >
