...
import { Box, Typography, Button, Stack, Container, Grid, Paper, Chip } from '@mui/material';
...
const ArchitectureModule = () => {
  ...
  return (
    <Box id="architecture" sx={{ py: 20, bgcolor: 'rgba(51, 204, 255, 0.02)', position: 'relative' }}>
      <Container maxWidth="lg">
        ...
        <Stack spacing={2} sx={{ mb: 12, textAlign: 'center' }}>
          <Box sx={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 2, mb: 1 }}>
            ...
            <Typography variant="caption" sx={{ color: '#00ffcc', fontWeight: 900, letterSpacing: 6, fontFamily: 'Syncopate', fontSize: '0.65rem' }}>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} lg={8}>
            ...
            >
              <Paper sx={{ 
                ...
                <Typography variant="h5" sx={{ color: 'white', fontWeight: 900, fontFamily: 'Syncopate', mb: 5, display: 'flex', alignItems: 'center', gap: 2 }}>
                  <Cpu color="#00ffcc" /> FULL_STACK_SCHEMATIC
                </Typography>
                ...
                <Grid container spacing={4}>
                  {techStack.map((tech, i) => (
                    <Grid item xs={12} sm={6} key={i}>
                      <Box sx={{ 
                        p: 3, borderRadius: 3, bgcolor: 'rgba(255,255,255,0.02)', 
                        border: '1px solid rgba(255,255,255,0.05)',
                        transition: '0.3s',
                        '&:hover': { borderColor: tech.color, transform: 'translateX(10px)' }
                      }}>
                        <Stack direction="row" spacing={3} alignItems="center">
                          ...
                          <Box>
                            <Typography sx={{ color: 'white', fontWeight: 900, fontSize: '0.9rem', fontFamily: 'Syncopate' }}>{tech.name}</Typography>
                            <Typography variant="caption" sx={{ color: '#444', fontWeight: 700 }}>{tech.desc.toUpperCase()}</Typography>
                          </Box>
                        </Stack>
                      </Box>
                    </Grid>
          ...
          <Grid item xs={12} lg={4}>
            <Stack spacing={4}>
               <Paper sx={{ p: 4, bgcolor: 'rgba(2, 4, 10, 0.9)', borderRadius: 5, border: '1px solid rgba(51, 204, 255, 0.1)' }}>
               ...
               <Paper sx={{ p: 4, bgcolor: 'rgba(2, 4, 10, 0.9)', borderRadius: 5, border: '1px solid rgba(255, 51, 102, 0.1)' }}>
